...
<header class="header-container">
    <div class="container">
        <div class="header-top">
            ...
            <a class="logo-text" href="index.php?page=home">Trạm Tin Việt</a>
            <div class="auth-links" style="font-size: 0.8rem; font-weight: 700; display: flex; gap: 15px;">
                <a href="#" style="color: white; text-decoration: none;">Đăng Ký</a>
        ...
        <nav class="nav-bar">
            <ul class="menu-items">
                <li><a href="index.php?page=home" class="active">Trang Chủ</a></li>
