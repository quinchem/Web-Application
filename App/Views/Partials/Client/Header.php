...
<header class="header-container">
    <div class="container" style="width: 1140px;">
        <div class="header-top">
          ...
          <div class="auth-links" style="font-size: 0.8rem; font-weight: 700; display: flex; gap: 15px; align-items: center;">
                <?php if (isset($_SESSION['user_id']) && $_SESSION['role_id'] === 'RL0002'): ?>
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <a href="index.php?page=logout" style="color: white; text-decoration: none; border: 1px solid rgba(255,255,255,0.7); padding: 5px 12px; border-radius: 4px; font-size: 0.7rem; font-weight: 600; margin-left: 8px; transition: 0.3s;">
                            ĐĂNG XUẤT
                        </a>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <a href="#" style="color: white; text-decoration: none;" data-bs-toggle="modal" data-bs-target="#loginModal">Đăng Nhập</a>
...
</header> <?php if (isset($_SESSION['success_msg'])): ?>
    <script>
