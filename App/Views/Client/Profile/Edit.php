...
<style>
    ...
    .form-custom-input {
        ...
        border-radius: 4px !important; /* Đã sửa thành 4px cho đồng bộ */
    ...
    <div class="profile-edit-container p-2">
        ...
        <form action="index.php?page=handle_profile" method="POST" id="profileForm">
            ...
            <div class="d-flex align-items-center gap-4 mb-4">
                ...
                <div>
                    <h5 class="fw-bold text-dark mb-1" style="color: #03254c !important; font-family: 'Barlow', sans-serif;">Ảnh đại diện</h5>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <a href="#" class="btn-remove-img" style="margin-left: 10px;">Gỡ bỏ</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-custom-input" name="username" id="inputUsername" value="<?= $uName; ?>" required readonly>
                </div>
