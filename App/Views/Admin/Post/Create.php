...
<head>
    ...
    <!-- jQuery (bắt buộc load trước PostCreate.js) -->
            ...
            <form method="POST" action="Admin_index.php?page=store_post" enctype="multipart/form-data" id="postForm">
                ...
                <div class="editor-card">
                    ...
                    <div class="thumbnail-upload" id="thumbnailZone">
                        ...
                        <div class="upload-placeholder" id="uploadPlaceholder" onclick="document.getElementById('thumbnailInput').click()">
                    ...
                    <div class="meta-row">
                        <div class="meta-group">
                            ...
                            <select name="category_id" id="childCatSelect" class="meta-select" disabled style="opacity:0.5">
                                ...
                                <!-- Thời sự -->
                                <option value="11" data-parent="1">Chính trị</option>
                                <option value="12" data-parent="1">Xã hội</option>
                                <option value="13" data-parent="1">Quân sự</option>
                                <!-- Kinh tế -->
                                <option value="21" data-parent="2">Thị trường</option>
                                <option value="22" data-parent="2">Ngân hàng</option>
                                <option value="23" data-parent="2">Chứng khoán</option>
                                <option value="24" data-parent="2">Doanh nghiệp</option>
                            </select>
                        </div>
