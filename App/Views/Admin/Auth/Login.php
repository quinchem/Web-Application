...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <form
        action="http://localhost/Web-Application/Admin_index.php?page=admin_login" method="POST">
            ...
            <div class="login-options">
                ...
                <a href="http://localhost/Web-Application/Admin_index.php?page=forgot_password" class="forgot-password">
                    Quên mật khẩu?
                </a>
            </div>
