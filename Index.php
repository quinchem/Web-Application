...
// Tự động nạp file Class theo Namespace (Autoload)
...
// Nạp cấu hình các file định tuyến con (Chỉ làm nhiệm vụ đăng ký cấu hình)
require_once __DIR__ . '/Routes/Auth.php';  
require_once __DIR__ . '/Routes/Profile.php';
require_once __DIR__ . '/Routes/Post.php';
require_once __DIR__ . '/Routes/Client.php'; 

// Kiểm tra phương thức HTTP của yêu cầu hiện tại (GET, POST, v.v.)
